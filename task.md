...
| 티켓번호 | 영역 | 수행 여부 | 내용 | 작업자 | 연관 티켓 | 비고 | 완료일자 |
|----------|------|:---------:|------|--------|-----------|------|----------|
| t-20260510-036 | 기능 | ✅ | 이메일 수신 거부(구독 취소) 기능 — 발송 이메일 하단에 1-click 구독 취소 링크 추가, 클릭 시 해당 구독자 DB에서 제거 | Codex | t-20260510-007 | CAN-SPAM/개인정보보호법 준수 관점에서 필요 | 2026-05-10 |
...
| t-20260510-044 | 문서 | ✅ | Windows 로컬 실행 가이드 작성 — Node.js v22+ 설치, npm install, 환경변수 설정, seed 실행까지 단계별 스크린샷 포함 가이드 | Codex | t-20260510-003, t-20260510-033 | better-sqlite3 제거로 빌드 도구 불필요하지만 Node 버전 주의 필요 | 2026-05-10 |
